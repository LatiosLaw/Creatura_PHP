...
(1, 'Snorlax', 1, 0, 'Gigante dormilón con gran resistencia', 160, 110, 65, 65, 110, 30, 'SYSTEM', 'snorlax.png', 1),
(2, 'Charizard', 2, 10, 'Dragón ígneo con alas imponentes', 78, 84, 78, 109, 85, 100, 'SYSTEM', 'charizard.png', 1),
(3, 'Blastoise', 3, 0, 'Tortuga con cañones de agua', 79, 83, 100, 85, 105, 78, 'SYSTEM', 'blastoise.png', 1),
(4, 'Pikachu', 4, 0, 'Ratón eléctrico popular', 35, 55, 40, 50, 50, 90, 'SYSTEM', 'pikachu.png', 1),
(5, 'Venusaur', 5, 8, 'Planta venenosa con flor dorsal', 80, 82, 83, 100, 100, 80, 'SYSTEM', 'venusaur.png', 1),
(6, 'Glaceon', 6, 0, 'Evolución de Eevee tipo hielo', 65, 60, 110, 130, 95, 65, 'SYSTEM', 'glaceon.png', 1),
(7, 'Machamp', 7, 0, 'Luchador musculoso con cuatro brazos', 90, 130, 80, 65, 85, 55, 'SYSTEM', 'machamp.png', 1),
(8, 'Nidoking', 8, 9, 'Rey venenoso con fuerza de tierra', 81, 102, 77, 85, 75, 85, 'SYSTEM', 'nidoking.png', 1),
(9, 'Garchomp', 9, 15, 'Dragón de tierra letal', 108, 130, 95, 80, 85, 102, 'SYSTEM', 'garchomp.png', 1),
(10, 'Togekiss', 10, 18, 'Ave hada que irradia paz', 85, 50, 95, 120, 115, 80, 'SYSTEM', 'togekiss.png', 1),
(11, 'Alakazam', 11, 0, 'Psíquico brillante y veloz', 55, 50, 45, 135, 95, 120, 'SYSTEM', 'alakazam.png', 1),
(12, 'Scyther', 12, 10, 'Insecto cortante con alas', 70, 110, 80, 55, 80, 105, 'SYSTEM', 'scyther.png', 1),
(13, 'Tyranitar', 13, 16, 'Bestia rocosa y oscura', 100, 134, 110, 95, 100, 61, 'SYSTEM', 'tyranitar.png', 1),
(14, 'Gengar', 14, 8, 'Fantasma juguetón y astuto', 60, 65, 60, 130, 75, 110, 'SYSTEM', 'gengar.png', 1),
(15, 'Dragonite', 15, 10, 'Dragón amable con gran poder', 91, 134, 95, 100, 100, 80, 'SYSTEM', 'dragonite.png', 1),
(16, 'Umbreon', 16, 0, 'Eevee evolución sombría', 95, 65, 110, 60, 130, 65, 'SYSTEM', 'umbreon.png', 1),
(17, 'Metagross', 17, 11, 'Supercomputadora metálica', 80, 135, 130, 95, 90, 70, 'SYSTEM', 'metagross.png', 1),
(18, 'Sylveon', 18, 0, 'Hada elegante con lazos', 95, 65, 65, 110, 130, 60, 'SYSTEM', 'sylveon.png', 1),
(19, 'Infernape', 2, 7, 'Mono ardiente maestro del combate', 76, 104, 71, 104, 71, 108, 'SYSTEM', 'infernape.png', 1),
(20, 'Lucario', 7, 17, 'Aura metálica con estilo', 70, 110, 70, 115, 70, 90, 'SYSTEM', 'lucario.png', 1),
(21, 'Greninja', 3, 16, 'Ninja veloz tipo agua/siniestro', 72, 95, 67, 103, 71, 122, 'SYSTEM', 'greninja.png', 1),
(22, 'Decidueye', 5, 14, 'Arquero espectral planta/fantasma', 78, 107, 75, 100, 100, 70, 'SYSTEM', 'decidueye.png', 1),
(23, 'Corviknight', 17, 10, 'Ave metálica caballeresca', 98, 87, 105, 53, 85, 67, 'SYSTEM', 'corviknight.png', 1),
(24, 'Dragapult', 15, 14, 'Dragón fantasma ultra rápido', 88, 120, 75, 100, 75, 142, 'SYSTEM', 'dragapult.png', 1),
(25, 'Toxtricity', 8, 4, 'Eléctrico punk tóxico', 75, 98, 70, 114, 70, 75, 'SYSTEM', 'toxtricity.png', 1),
(26, 'Gardevoir', 11, 18, 'Dama psíquica/fada elegante', 68, 65, 65, 125, 115, 80, 'SYSTEM', 'gardevoir.png', 1),
(27, 'Mamoswine', 9, 6, 'Mamífero glacial con colmillos', 110, 130, 80, 70, 60, 80, 'SYSTEM', 'mamoswine.png', 1),
(28, 'Hawlucha', 7, 10, 'Luchador volador acrobático', 78, 92, 75, 74, 63, 118, 'SYSTEM', 'hawlucha.png', 1),
(29, 'Aegislash', 17, 14, 'Espada fantasma que cambia forma', 60, 50, 150, 50, 150, 60, 'SYSTEM', 'aegislash.png', 1),
(30, 'Roserade', 5, 8, 'Rosa venenosa encantadora', 60, 70, 65, 125, 105, 90, 'SYSTEM', 'roserade.png', 1),
