            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($habilidades as $habilidad): ?>
                        ...
                        <tr>
                            <td><a href="/Creatura_PHP/paginas/ver_habilidad.php?nombre_habilidad=<?= urlencode($habilidad['nombre_habilidad']) ?>&creador=<?= urlencode($habilidad['creador']) ?>&id_habilidad=<?= urlencode($habilidad['id_habilidad']) ?>">
                                    <div><?= htmlspecialchars($habilidad['nombre_habilidad']) ?></div>
                                </a></td>
