...
public function retornar_rating($nickname, $id_creatura) {
    ...
    public function devolverTiposMagia($controladorTipo, $tipo1Name, $tipo2Name) {

        $tipo1 = $controladorTipo->retornar_tipoPorNombre($tipo1Name);
        $tipo2 = $controladorTipo->retornar_tipoPorNombre($tipo2Name);
        $resultado = [
            'tipo1' => $tipo1,
            'tipo2' => $tipo2,
        ];
