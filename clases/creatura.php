...
class Creatura {
  ...
  function alta_creatura($nombre_creatura, $id_tipo1, $id_tipo2, $descripcion, $hp, $atk, $def, $spa, $sdef, $spe, $creador, $imagen, $publico, $conexion) {
    $query = "INSERT INTO creatura (
        nombre_creatura, id_tipo1, id_tipo2, descripcion, hp, atk, def, spa, sdef, spe, creador, imagen, publico
    ) VALUES (
        '$nombre_creatura', $id_tipo1, $id_tipo2, '$descripcion',
        $hp, $atk, $def, $spa, $sdef, $spe, '$creador', '$imagen', $publico
    )";
...
function modificar_creatura($id_creatura, $nombre_creatura, $id_tipo1, $id_tipo2, $descripcion, $hp, $atk, $def, $spa, $sdef, $spe, $creador, $imagen, $publico, $conexion) {
    $query = "UPDATE creatura SET
        nombre_creatura = '$nombre_creatura',
        id_tipo1 = $id_tipo1,
        id_tipo2 = $id_tipo2,
